...
class Slide extends Component {
  constructor(props) {
    super(props)
    this.stepsList = [{
      style: { marginLeft: '250px' }, step: 'Step five', description: 'Drew custom illustrations, and designed the whole thing', footer: 'Big thanks to Adobe Illustrator, which allowed us to draw and perfect these beauties. These guys are real members of our team, by the way.',
    },
    {
